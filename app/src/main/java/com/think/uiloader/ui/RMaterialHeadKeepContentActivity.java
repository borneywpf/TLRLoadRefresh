...
public class RMaterialHeadKeepContentActivity extends AppCompatActivity implements ImageContract.View {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tlrmaterialhead_keepcontent);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(RMaterialHeadKeepContentActivity.this, "onclick " + position, Toast.LENGTH_SHORT).show();
            }
        });
    }
