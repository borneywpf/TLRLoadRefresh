 ...
 */
public class RLListViewActivity extends AppCompatActivity implements ImageContract.View {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tlr_r_l_listview);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(RLListViewActivity.this, "onclick " + position, Toast.LENGTH_SHORT).show();
            }
        });
    }
