 ...
 */
public class TLRSunofOtherActivity extends AppCompatActivity implements ImageContract.View {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tlrsunofother);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(TLRSunofOtherActivity.this, "onclick " + position, Toast.LENGTH_SHORT).show();
            }
        });
    }
